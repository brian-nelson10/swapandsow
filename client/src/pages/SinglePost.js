...
const SinglePost = (props) => {
    ...
    return (
        <div className='flex items-center justify-center rounded-xl h-max grid py-[9rem] px-[7rem] xl:grid xl:grid-cols-3 xl:-gap-4'>
            <div className='xl:px-[12rem] xl:col-span-2 xl:grid'>
            <div className="card mb-3 p-8 shadow-xl bg-gray-200 rounded-lg grid items-center justify-center">
                <p className="card-header text-black font-bebas tracking-wide bg-gray-100 border-b-2 border-black">
                ...
                <div className="card-body leading-snug font-lofi text-start font-bold md:leading-normal text-[2rem]">
                    <p className=' bg-gray-100'>{post.postText}</p>
                    <div className='border-gray-100 border-4'>
                ...
                <div className='p-4 grid grid-cols-2 font-lofi text-[1.3rem]'>
                  ...
                  {/* <Link to={`/post/${post._id}`}> */}
                    <div className='flex-row flex gap-4 text-end justify-end mt-1'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <div className='xl:mr-12 xl:-ml-10'>
